...
val <T> Either<T, T>.value: T get() = unsafeValue as T
...
inline fun <reified T> Either<T, *>.leftOrNull(): T? = unsafeValue as? T
inline fun <reified T> Either<*, T>.rightOrNull(): T? = unsafeValue as? T
